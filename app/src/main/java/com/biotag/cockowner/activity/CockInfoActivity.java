...
import com.biotag.cockowner.adapter.FragmentViewPagerAdapter;
import com.biotag.cockowner.fragment.MainFragment;
...
public class CockInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cock_detail_info);
...
//                android.R.color.holo_green_light
        ...
        initfragments();
        initviewpager();
        coordinatortabLayout.setTitle("sssssssssssssssss")
                .setBackEnable(true)
